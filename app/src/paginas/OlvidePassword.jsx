    ...
    <>
      ...
      <div className='mt-5 shadow-lg px-5 py-10 rounded-xl bg-white'>
        ...
        <form onSubmit={handleSubmit}>
          ...
          <input type='submit' value='Enviar' className='bg-indigo-700 w-full py-3  px-10 rounded-xl text-white uppercase font-bold mt-5 hover:cursor-pointer hover:bg-indigo-800 md:w-auto' />
        </form>
        <nav className='text-center mt-10 flex flex-col gap-4 lg:flex-row lg:justify-between'>
          <Link className='block text-gray-500' to='/'>¿Recordaste tu contraseña? Inicia Sesión</Link>
          <Link className='block text-gray-500' to='/registrar'>¿No tienes una cuenta? Regístrate</Link>
        </nav>
      </div>
    </>
  )
